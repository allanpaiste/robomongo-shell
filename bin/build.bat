...
echo -------------------------------------
scons mongo.exe %BUILD_TYPE% --ssl CPPPATH=%OPENSSL_PATH%\inc32 LIBPATH=%OPENSSL_PATH%\out32dll -j8 --dynamic-windows --link-model=object --disable-minimum-compiler-version-enforcement
